                ...
                <div className="mt-16">
                    ...
                    <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-xl overflow-hidden">
                        <div className="md:flex">
                            ...
                            <div className="px-6 pt-2 pb-6 md:p-8 text-center md:text-left">
                                <h3 className="mt-0 text-3xl md:text-4xl font-extrabold text-brand-space">Rocket Science</h3>
                                <p className="text-lg text-slate-600">Full-Fledged Course for Kids</p>

                                <div className="mt-6 grid grid-cols-2 gap-x-4 gap-y-6 text-sm text-slate-700 text-left">
                                    {programTags.map(tag => (
