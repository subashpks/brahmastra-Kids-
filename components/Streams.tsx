...
const programTags = [
    ...
    { icon: <CalendarIcon />, text: '2 Sessions/Week (Evening)' },
    { icon: <UserGroupIcon />, text: 'Max 10 Students' },
            ...
            <section className="py-20 bg-slate-50 border-y border-slate-200">
                <div className="container mx-auto px-6">
                    <div className="flex items-center justify-center gap-3 mb-12">
                        ...
                        <h2 className="text-2xl font-bold text-slate-800 uppercase tracking-wide">Live Now: Featured Cohort</h2>
                    </div>
                    ...
                    <div className="max-w-5xl mx-auto bg-gradient-to-br from-slate-900 to-slate-800 rounded-3xl shadow-2xl overflow-hidden text-white group">
                        <div className="md:grid md:grid-cols-2">
                            ...
                            <div className="p-8 md:p-12 flex flex-col justify-center">
                                <h3 className="text-3xl font-bold mb-4 text-white">From Paper Planes to Propulsion</h3>
