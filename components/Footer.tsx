                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center md:text-left">
                    ...
                    <div className="flex flex-col items-center md:items-start space-y-4">
                        ...
                        <div className="flex space-x-4 pt-2">
                            <a href="https://www.instagram.com/brahmastra.ltd/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-slate-200 hover:text-white"><InstagramIcon /></a>
                            <a href="https://www.facebook.com/brahmastrakids" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-slate-200 hover:text-white"><FacebookIcon /></a>
                            <a href="https://x.com/brahmastrakids" target="_blank" rel="noopener noreferrer" aria-label="X" className="text-slate-200 hover:text-white"><XIcon /></a>
                            <a href="https://www.linkedin.com/company/brahmastraspace/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-slate-200 hover:text-white"><LinkedInIcon /></a>
                        </div>
                    </div>
