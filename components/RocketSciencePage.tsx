...
import { ROCKET_SCIENCE_COURSES } from '../constants';
  ...
  return (
    <section id="rocket-science" className="py-16 md:py-24 animate-fade-in-up">
      <div className="container mx-auto px-6">
        ...
        <div className="mt-16">
            <h3 className="text-2xl font-bold text-center text-slate-800 mb-8">Your Rocket Science Mission</h3>
             <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                {ROCKET_SCIENCE_COURSES.map((course, index) => (
