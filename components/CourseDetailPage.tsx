...
export const CourseDetailPage: React.FC<PageProps> = ({ navigate }) => {
    ...
    const HeroImage = () => (
        <div className="relative w-full max-w-md mx-auto lg:max-w-lg">
            ...
            <img src="https://files.catbox.moe/knklae.png" alt="Cartoon Rocket blasting off" className="relative animate-float" />
        </div>
    );
                        ...
                        <div className="mt-10 lg:mt-0">
                            <div className="sticky top-24">
                                <div className="bg-white rounded-2xl shadow-xl border border-slate-200 overflow-hidden">
                                    <img src="https://files.catbox.moe/knklae.png" alt="Cartoon Rocket" className="w-full aspect-square object-cover"/>
                                    <div className="p-6">
