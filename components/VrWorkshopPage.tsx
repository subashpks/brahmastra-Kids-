                    ...
                    <div className="lg:grid lg:grid-cols-3 lg:gap-12">
                        ...
                        <div className="lg:col-span-2">
                            <div className="bg-slate-50 p-6 sm:p-8 rounded-2xl shadow-inner">
                                <DetailSection icon={<LearnIcon/>} title="What You'll Experience">
                            ...
                            <div className="mt-10">
                                <DetailSection icon={<SyllabusIcon/>} title="Workshop Itinerary">
                                    <div>
                                ...
                                <DetailSection icon={<ActivitiesIcon/>} title="Immersive VR Activities">
                                ...
                                <DetailSection icon={<SchoolIcon/>} title="Connects to School Syllabus">
                                ...
                                <DetailSection icon={<ExperienceIcon/>} title="The Brahmastra Experience">
                                     <ul className="space-y-3 text-slate-600">
                                        <li className="flex items-start gap-3"><span className="text-pink-500 font-bold mt-1">●</span><div><strong>Safe & Guided:</strong> A fully supervised and safe virtual environment guided by our expert mentors at every step.</div></li>
                                        <li className="flex items-start gap-3"><span className="text-pink-500 font-bold mt-1">●</span><div><strong>Collaborative Fun:</strong> Kids share their amazing virtual discoveries with each other, making it a social and exciting group activity.</div></li>
