      ...
      <div className="container mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-left">
                <h2 className="text-3xl md:text-4xl font-bold tracking-tight text-lime-600">
            ...
            <div className="flex justify-center">
                <img src="https://i.postimg.cc/qM6gK8qB/astrobiology.png" alt="Cartoon depiction of astrobiology concepts" className="w-full max-w-sm" />
            </div>
        </div>
